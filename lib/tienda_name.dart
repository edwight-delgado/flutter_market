...
class TiendaStoreName extends StatefulWidget {
  const TiendaStoreName({super.key});

  @override
  State<TiendaStoreName> createState() => _TiendaStoreNameState();
}

class _TiendaStoreNameState extends State<TiendaStoreName> {
  ...
  _getTopForBlackPanel(TiendaState state, Size size) {
    if (state == TiendaState.normal) {
      return size.height - cardBarHeight - (kToolbarHeight * .95) - 50;
    } else if (state == TiendaState.cart) {
                ...
                bottomNavigationBar: bloc.tiendaState == TiendaState.normal
                    ? BottomNavigationBar(items: [
                        ...
                        BottomNavigationBarItem(
                            ...
                            label: 'map'),
                        BottomNavigationBarItem(
                            icon: Icon(Icons.person), label: 'label3')
                      ])
                    : SizedBox.shrink(),
              );
            }));
